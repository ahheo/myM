...
% detrend_NAN removes the trend from data, NaN's are considered as missing values
%
% DETREND_NAN is fully compatible to previous Matlab and Octave DETREND with the following features added:
