...
id=[52818;52836;52866;55299;55591;56029;56080;56137;56146;56571];

indir = 'E:/data/global_radiosonde/';
outdir = 'E:/data/igra_tp_cape/p_t_td/';
...
%             sid = str2num(header{1}{1}(2:6)); 
            ...
            fprintf(fidout,'%4.4d%2.2d%2.2d%2.2d nlevel:%4d\n',label,nlevel);
            fprintf(fidout,'%8.0f%8.1f%8.1f\n',data');
            clear p t td;
